            ...
            <div className="qualification__sections">
                <div className={toggleState === 1 ? "qualification__content qualification__content-active"
                    ...
                    <div className="qualification__data">
                        <div>
                            <h3 className="qualification__title">ECE</h3>
                            <span className="qualification__subtitle">Karpagam College of Engineering</span>
                ...
                <div className={toggleState === 2 ? "qualification__content qualification__content-active"
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">Blackflux Technologies</span>
                            <div className="qualification__calendar">
                                <HiOutlineCalendar className="qualification__calendar-icon" />
                                2023-2024
                            </div>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">Trustt</span>
                            <div className="qualification__calendar">
                                <HiOutlineCalendar className="qualification__calendar-icon" />
                                2024-Present
                            </div>
